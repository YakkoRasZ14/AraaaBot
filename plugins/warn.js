let handler = async (m, { conn, args }) => {
    ...
    if (!(mention in global.DATABASE.data.users)) throw 'User tidak terdaftar dalam DATABASE!!'
    let user = global.DATABASE.data.users[mention]
