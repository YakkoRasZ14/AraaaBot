...
await m.reply('*[❗] WAIT, Tunggu Sebentar*')     axios.get(`https://alfians-api.herokuapp.com/api/stalk?username=${teks}`).then ((res) =>{
...
handler.help = ['igstalkv3(Perbaikan)']
handler.tags = ['internet']
handler.command = /^igstalkv3$/i
handler.owner = false
handler.mods = false
